		...
		<c:if test="${not empty usuarioLogueado}">
		   <div class="navbar-wrapper">
			                    ...
			                    <ul class="nav navbar-nav pull-right">
			                        <li class=" dropdown"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">${usuarioLogueado.usuario}  <span class="caret"></span></a>
			                            <ul class="dropdown-menu">
			                                <li><a href="modificarPersona">Editar mis datos</a></li>
			                                <li><a href="verDatosUsuarioSesion">Ver mis datos</a></li>
			                            </ul>
			                        </li>
			...
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
				<h2 style="margin-bottom: 20px;">Lista de personas</h2>
				<table class="table">
				  <thead>
				    <tr>
				      <th>Usuario</th>
				  ...
				  <tbody>
				      <c:forEach items="${listaPersonas}" var="pers">
					      ...
					      <td>${pers.apellido}</td>
					      <td>${pers.edad}</td>
					      <td class="text-center"><a href="modificarPersonaLista?id=${pers.id}" class="btn btn-info">Modificar usuario</a>  <a href="eliminarPersonaLista?id=${pers.id}" class="btn btn-warning">Borrar usuario</a></td>
					    </tr>
					  </c:forEach>
				  </tbody>
				</table>
