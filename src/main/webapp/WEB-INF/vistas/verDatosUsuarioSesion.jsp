			...
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
				...
				<table class="table">
				  ...
				  <tbody>
					      ...
					      <td>${usuarioLogueado.edad}</td>
					      <td class="text-center"><a href="modificarPersona" class="btn btn-info">Modificar usuario</a>  <a href="eliminarPersona" class="btn btn-warning">Borrar usuario</a></td>
					    </tr>
				  </tbody>
				</table>
